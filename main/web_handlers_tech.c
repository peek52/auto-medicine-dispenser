...
"<input id='cam-q' type='range' min='20' max='90' step='5' value='35' style='width:200px'>"
"<span id='cam-q-val' style='color:#9ae8d0;font-weight:700;min-width:36px;text-align:right'>35</span>"
"</label>"
"<button class='btn ghost' id='cam-q-apply' style='min-height:36px'>นำไปใช้</button>"
"<span style='font-size:12px;color:#a7bdd7'>ต่ำ = ภาพหยาบ ลื่นขึ้น &middot; สูง = ภาพคมชัด ช้าลง</span>"
"</div>"
