...
"<div class='sub'>ตั้งค่าระยะยาเต็ม &middot; ความสูงเม็ดยา 15mm &middot; ความจุสูงสุด &middot; บันทึกใน NVS</div>"
"<div class='cards' id='cal-cards'></div>"
"<div class='row' style='margin-top:14px'>"
"<button class='btn ghost' id='cal-refresh'>Refresh Live Readings</button>"
"</div>"
"</div>"
...
"    const status=s.present?(s.valid?'<span style=\\'color:#9ae8d0\\'>online</span>':'<span style=\\'color:#ffd166\\'>no data</span>'):'<span style=\\'color:#ff8a80\\'>offline</span>';"
"    h+=\"<div class='card'><div class='k'>VL53 Ch\"+s.ch+\" \"+status+\"</div>\""
"     +\"<div style='margin-top:6px;font-size:13px;color:#a7bdd7'>dist=<b style='color:#fff'>\"+(s.filtered_mm>=0?s.filtered_mm:'-')+\"mm</b> &middot; count=<b style='color:#fff'>\"+(s.pill_count>=0?s.pill_count:'-')+\" pills</b></div>\""
"     +\"<div style='display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;margin-top:10px'>\""
"     +\"<label style='font-size:11px;color:#a7bdd7'>Full(mm)<input id='cf\"+s.ch+\"' type='number' min='1' max='500' value='\"+s.full_dist_mm+\"' style='width:100%;margin-top:3px;padding:5px;border-radius:6px;border:1px solid #35567f;background:#06101e;color:#f4f8ff;font-size:13px'></label>\""
"     +\"<label style='font-size:11px;color:#a7bdd7'>Height(mm)<input id='ch\"+s.ch+\"' type='number' min='1' max='100' value='\"+s.pill_height_mm+\"' style='width:100%;margin-top:3px;padding:5px;border-radius:6px;border:1px solid #35567f;background:#06101e;color:#f4f8ff;font-size:13px'></label>\""
"     +\"<label style='font-size:11px;color:#a7bdd7'>Max<input id='cm\"+s.ch+\"' type='number' min='1' max='99' value='\"+s.max_pills+\"' style='width:100%;margin-top:3px;padding:5px;border-radius:6px;border:1px solid #35567f;background:#06101e;color:#f4f8ff;font-size:13px'></label>\""
"     +\"</div>\""
"     +\"<button class='btn primary' data-cal='\"+s.ch+\"' style='margin-top:8px;min-height:36px;width:100%;font-size:13px'>Save</button>\""
"     +\"</div>\";"
"  }wrap.innerHTML=h;"
...
"    if(isNaN(f)||isNaN(ph)||isNaN(mx))return alert('Invalid');"
"    b.textContent='Saving...';"
"    try{const r=await fetch('/sensors/config',{method:'POST',headers:{'Content-Type':'application/x-www-form-urlencoded'},body:'ch='+i+'&full_dist_mm='+f+'&pill_height_mm='+ph+'&max_pills='+mx});const j=await r.json();b.textContent=j.ok?'Saved':'Error';}catch(e){b.textContent='Error';}"
