...
"<h2>Dispenser &middot; Servo Test &amp; Calibration</h2>"
"<div class='sub'>ตั้งค่ามุม Home/Work ต่อช่อง + ทดสอบ — บันทึกใน NVS อัตโนมัติ</div>"
...
"<button class='btn ghost' id='servo-refresh'>Refresh State</button>"
"</div>"
"<div class='placeholder' style='margin-top:18px'><p>Home/Work = มุมตำแหน่ง (0-180&deg;) &middot; กด <b>Save</b> เพื่อบันทึก &middot; Test = หมุนไป-กลับเพื่อเช็ค</p></div>"
"</div>"
...
"    h+=\"<div class='card'><div class='k'>Servo Ch\"+i+\" <span style='float:right;color:#9ae8d0'>now: \"+s.cur+\"&deg;</span></div>\""
"    +\"<div style='display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px'>\""
"    +\"<label style='font-size:12px;color:#a7bdd7'>Home<input id='h\"+i+\"' type='number' min='0' max='180' value='\"+s.home+\"' style='width:100%;margin-top:4px;padding:6px 8px;border-radius:8px;border:1px solid #35567f;background:#06101e;color:#f4f8ff'></label>\""
"    +\"<label style='font-size:12px;color:#a7bdd7'>Work<input id='w\"+i+\"' type='number' min='0' max='180' value='\"+s.work+\"' style='width:100%;margin-top:4px;padding:6px 8px;border-radius:8px;border:1px solid #35567f;background:#06101e;color:#f4f8ff'></label>\""
"    +\"</div><div class='row' style='margin-top:10px;gap:6px;flex-wrap:wrap'>\""
"    +\"<button class='btn primary' data-save='\"+i+\"' style='min-height:36px;padding:0 10px;font-size:13px'>Save</button>\""
"    +\"<button class='btn ghost' data-ch='\"+i+\"' data-act='home' style='min-height:36px;padding:0 10px;font-size:13px'>Home</button>\""
"    +\"<button class='btn ghost' data-ch='\"+i+\"' data-act='work' style='min-height:36px;padding:0 10px;font-size:13px'>Work</button>\""
"    +\"<button class='btn ghost' data-ch='\"+i+\"' data-act='test' style='min-height:36px;padding:0 10px;font-size:13px'>Test</button>\""
