...
"<h2>ภาพถ่ายทอดสด</h2>"
"<div class='sub'>MJPEG stream (OV5647 &middot; 800x640 &middot; 50 fps) &middot; กด \"เริ่มสตรีม\" เพื่อรับภาพ</div>"
"<div class='row'>"
...
"<div class='sub'>เลือก SSID และบันทึก &middot; บอร์ดจะรีสตาร์ทอัตโนมัติเพื่อเชื่อมต่อใหม่</div>"
